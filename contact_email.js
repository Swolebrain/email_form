...
app.post("/email-cv", function(req,res){
    ...
    */
    var emailBody = "This is a test. only temporary. This is where your html email body will go.";
...
app.get('/email', function(req,res){
    ...
    "\nVariable names are full_name, phone, ddate, hora, email, and the dest_email hidden input.");
});
